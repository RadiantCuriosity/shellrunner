...
** background
Takes a full string as input and immediatly return a unique 8-character hexadecimal ID.
...
# Check the status of a job (e.g., 00000001)
go run client/main.go status "00000001"

# Get the output of a job and release it
go run client/main.go output "00000001" --release
